...
const MOCK_PAIEMENTS: Paiement[] = [
  { id: 'P-001', date: '01/07/2026', lotRef: 'L-003', material: 'Verre', montant: 8400, statut: 'paye' },
  { id: 'P-002', date: '28/06/2026', lotRef: 'L-002', material: 'Carton', montant: 3600, statut: 'paye' },
  { id: 'P-003', date: 'En attente', lotRef: 'L-001', material: 'PET', montant: 5000, statut: 'en_attente' },
];
  ...
  return (
    <div className="el-shell">
      ...
      <div className="el-main">
        <Navbar title="Mes revenus" searchOpen={searchOpen}
        ...
        <div className="el-content">
          <div className="el-kpi-grid">
            ...
            <div className="el-card">
              <div className="el-kpi-label">Moyenne par lot</div>
          ...
          <div className="el-card" style={{ marginTop: '0.5rem' }}>
            ...
            <div className="el-table-wrap">
              <table className="el-table">
                <thead>
                  <tr>
                    <th>Réf.</th><th>Date</th><th>Lot</th><th>Matériau</th><th>Montant</th><th>Statut</th>
                  </tr>
                </thead>
                <tbody>
