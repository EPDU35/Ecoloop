...
export function MainLayout() {
  ...
  return (
    <div className="app-shell">
      ...
      <AnimatePresence>
        {showBottomSheet && (
          <div key="bottom-sheet" className="fixed inset-0 bg-gray-900/60 backdrop-blur-sm z-50 flex flex-col justify-end animate-in fade-in duration-200" onClick={() => setShowBottomSheet(false)}>
            <motion.div 
              initial={{ y: "100%" }}
              animate={{ y: 0 }}
              exit={{ y: "100%" }}
