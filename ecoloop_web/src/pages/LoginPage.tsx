    ...
    <div className="login-page">
      <div className="login-container">
        ...
        <div className="mt-6 flex flex-col items-center gap-3 text-sm">
          <Link to="/register" className="text-ecoloop-green hover:underline font-medium">
            Pas encore de compte ? Inscrivez-vous
          </Link>
          <a href="#" onClick={(e) => e.preventDefault()} className="text-gray-500 hover:text-gray-700">
            Mot de passe oublié ?
          </a>
        </div>
      </div>
