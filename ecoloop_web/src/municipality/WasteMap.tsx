...
export default function WasteMap() {
  ...
  return (
    <AppLayout role="municipality" activeKey="carte" title="Carte des déchets &amp; zones critiques">
      <div className="el-filter-bar">
        <div className="el-filter-field">
          ...
          >
            ...
            <option value="wild_dump">Dépôts sauvages</option>
      ...
      <div className="el-grid-2" style={{ gridTemplateColumns: '3fr 2fr', gap: '1.5rem', marginTop: '1rem' }}>
        ...
        <div className="el-card" style={{ padding: 12, position: 'relative', overflow: 'hidden', minHeight: 400, background: 'var(--el-paper-2)', display: 'flex', flexDirection: 'column' }}>
          ...
          <div style={{ flex: 1, position: 'relative' }}>
            <svg 
              ...
              role="img"
              aria-label="Carte vectorielle des déchets d'Abidjan"
            >
              <title>Carte des déchets d'Abidjan</title>
          ...
          {/* Légende de la carte */}
          <div style={{ display: 'flex', gap: '1.5rem', marginTop: '1rem', padding: '0.5rem 0 0', borderTop: '1px solid var(--el-line-dark)', fontSize: '0.8rem', flexWrap: 'wrap' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              <span style={{ width: 12, height: 12, borderRadius: '50%', background: '#b4522f', display: 'inline-block' }}></span>
              <strong>Dépôt Sauvage (Critique)</strong>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              <span style={{ width: 12, height: 12, borderRadius: '50%', background: '#3fa34d', display: 'inline-block' }}></span>
              <strong>Forte Production (Matériaux recyclables)</strong>
            </div>
          </div>
        </div>
        ...
        <div className="el-card" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
          ...
          <div style={{ borderTop: '1px solid var(--el-line-dark)', paddingTop: '1rem', marginTop: '1rem', fontSize: '0.8rem', color: 'var(--el-ink-soft)', display: 'flex', gap: 6, alignItems: 'center' }}>
