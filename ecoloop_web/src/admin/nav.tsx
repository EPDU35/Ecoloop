...
export const NAV_ITEMS: NavItem[] = [
  ...
  { key: 'users', label: 'Utilisateurs', icon: <SuppliersIcon /> },
  { key: 'transactions', label: 'Transactions', icon: <TransactionsIcon /> },
  { key: 'payments', label: 'Paiements Mobile', icon: <PaymentsIcon /> },
  { key: 'settings', label: 'Configuration', icon: <SettingsIcon /> },
];
